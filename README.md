...
一个 Python 项目，使用 OpenAI API 和群晖 Synology Chat 套件搭建了一个聊天机器人，同时基于 ChatGPT-3.5 文本语言模型和 Edits 图片生成模型，并整合了即时在本地运行 Python 代码和 Bash 命令的能力 —— *it is more than ChatGPT*.
